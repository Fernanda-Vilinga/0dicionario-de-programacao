...
function favoritesRoutes(app) {
    return __awaiter(this, void 0, void 0, function* () {
        app.get('/favoritos/:id', (req, reply) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            try {
                const favoritosSnapshot = yield firebaseConfig_1.default.collection('favoritos').where('usuarioId', '==', id).get();
